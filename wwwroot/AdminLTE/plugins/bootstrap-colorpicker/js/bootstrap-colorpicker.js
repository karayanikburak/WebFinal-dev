...
exports.default = {
   ...
   *
   * If false, it will be always hidden and alpha channel will be disabled also prOgrenciammatically, meaning that
...
var Colorpicker = function () {
  ...
  _createClass(Colorpicker, [{
    ...
    value: function setValue(val) {
      ...
      /**
       * (Colorpicker) When the color is set prOgrenciammatically with setValue().
       *
