  ...
  var DateTimePicker = /*#__PURE__*/function () {
    ...
    _proto._setValue = function _setValue(targetMoment, index) {
      var noIndex = typeof index === 'undefined',
          ...
          isNotAllowedPrOgrenciammaticUpdate = !this.isInit && this._options.updateOnlyThroughDateOption && !isDateUpdateThroughDateOptionFromClientCode;
      var outpValue = '',
          isInvalid = false,
      ...
      if (!targetMoment) {
        if (isNotAllowedPrOgrenciammaticUpdate) {
          this._notifyEvent({
